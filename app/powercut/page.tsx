  ...
  return (
    <div className="min-h-screen bg-white text-[var(--primary)]">
      ...
      <main>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-10 text-center">
                ...
                <a
                  ...
                  className="btn-accent inline-flex h-auto sm:h-20 items-center justify-center gap-2 sm:gap-3 rounded-2xl px-5 sm:px-14 py-4 sm:py-0 text-sm sm:text-2xl font-extrabold uppercase tracking-normal sm:tracking-wide leading-tight mt-8 shadow-2xl ring-4 ring-[var(--accent)]/30 animate-pulse-slow text-center max-w-full"
                >
                  Click Here to Order Your POWER CUT™ Stack
                  <svg
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-8 text-center p-8 rounded-3xl bg-[var(--accent)]/10 border border-[var(--accent)]/20">
                ...
                <a
                  ...
                  className="btn-accent inline-flex h-auto sm:h-20 items-center justify-center gap-2 sm:gap-3 rounded-2xl px-5 sm:px-14 py-4 sm:py-0 text-sm sm:text-2xl font-extrabold uppercase tracking-normal sm:tracking-wide leading-tight mt-6 shadow-2xl ring-4 ring-[var(--accent)]/30 animate-pulse-slow text-center max-w-full"
                >
          ...
          <Container>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-12">
                ...
                <a
                  href="/research-access"
                  className="btn-accent inline-flex h-20 items-center justify-center gap-3 rounded-2xl px-14 text-xl sm:text-2xl font-extrabold uppercase tracking-wide mt-8 shadow-2xl ring-4 ring-[var(--accent)]/30 animate-pulse-slow"
                >
        ...
        {/* What happens when people follow the system */}
        <Section className="bg-[var(--primary)] text-white">
          <Container>
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="mt-3 text-lg text-white/60">
                  Not perfect people. Just people who committed.
                </p>
              </div>

              <div className="grid sm:grid-cols-2 gap-6 mb-12">
                {[
                  "Down 20.8 lbs and 4.8% body fat\u2026 not slowing down\u2026 this is priceless.",
                  "Down 7 pounds since week one\u2026 everything is working out.",
                  "Foods I desire have changed\u2026 not deep into sugar and sweet treats anymore.",
                  "It used to feel like a chore\u2026 now it feels essential and I want to do it.",
                  "Sleeping better, more energy, joints popping less\u2026 this is exactly what I needed.",
                  "I\u2019ve tried everything\u2026 this feels different\u2026 everything just seems easier now.",
                ].map((quote) => (
                  <div
                    key={quote}
              ...
              <p className="text-center text-lg text-white/60 mb-10">
                Same protocol. Same structure. Different starting points.
              </p>
