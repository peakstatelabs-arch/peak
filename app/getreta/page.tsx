              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                <div>
                  ...
                  <p className="mt-4 text-lg text-[var(--primary)]/75 leading-relaxed">
                    Lyophilized, lab-tested, and ready to reconstitute. Pick a
                    single vial to start, or stock a full cycle so you never
                    pause mid-protocol.
                  </p>

                  <div className="mt-6 flex items-center justify-center rounded-3xl border border-[var(--border)] bg-white p-6">
                    <img
                      src="/reta-product.png"
                      alt="Retatrutide 20mg vial"
