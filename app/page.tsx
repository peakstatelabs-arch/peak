              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] p-8 sm:p-12 text-white shadow-2xl">
                ...
                <div className="relative text-center">
                  ...
                  <p className="mt-4 text-lg sm:text-xl font-bold text-[var(--accent)]">
                    GHK-Cu in stock now — ships within 24 hours.
                  </p>
                  ...
                  <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                    {[
                      { name: "Retatrutide", inStock: false, shipsBy: "7/7" },
                      { name: "CJC-1295 + Ipamorelin", inStock: false, shipsBy: "7/7" },
                      { name: "BPC-157 + TB-500", inStock: false, shipsBy: "7/7" },
