...
// Pre-order window closes at midnight Eastern on 6/22/2026 — i.e. the moment
// Saturday 6/21 ends and Sunday 6/22 (the ship date) begins. June is EDT
// (UTC-4), so midnight ET = 04:00 UTC.
const PREORDER_DEADLINE_MS = Date.UTC(2026, 5, 22, 4, 0, 0);
