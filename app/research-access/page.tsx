        ...
        <Section className="relative overflow-hidden gradient-hero !py-10 sm:!py-16">
          ...
          <Container className="relative">
            <div className="max-w-2xl mx-auto text-center">
              ...
              {/* Eyebrow */}
              <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-[var(--accent)]/40 bg-[var(--accent)]/15 px-4 py-2 text-xs sm:text-sm font-bold tracking-[0.18em] text-[var(--accent-dark)]">
