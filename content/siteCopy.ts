export const siteCopy = {
  ...
  urgencyBanner: {
    lineOne: "APRIL PRE-ORDER LIVE:",
    lineTwo: "Only 11 Stacks Left",
    shippingText: "Ships 4/16",
  ...
  hero: {
    ...
    secureNote:
      "SECURE YOUR PRE-ORDER: Guaranteed Shipping On 4/16. Reserve your kit now to lock in priority access to Batch 004.",
  ...
  pricing: {
    ...
    tiers: [
      ...
      },
      {
        ...
        stripeUrl: "https://buy.stripe.com/00wfZgfoHgwxcpP5PvafS09",
      ...
      },
      {
        ...
        stripeUrl: "https://buy.stripe.com/fZuaEW90jgwx3Tj1zfafS0a",
  ...
  safety: {
    ...
    documents: [
      ...
      { name: "CJC-1295 + Ipamorelin", amount: "10mg Blend", url: "/purity-tests/CJC IPA Lab Test.png" },
