export const siteCopy = {
  ...
  urgencyBanner: {
    ...
    stacks: {
      ...
      // 8 → 7 → 6 → 5 → 4 → 3, then back to 8 (6-day cycle, never below 3).
      anchorEasternDate: "2026-08-06",
    },
    ...
    items: [
      {
        name: "Retatrutide",
        amount: "20mg (2 vials)",
        url: "https://www.peakstate.shop/reta",
        image: "/reta-product.png",
      },
      {
        name: "CJC-1295 + Ipamorelin",
        amount: "10mg Blend (2 vials)",
        url: "https://www.peakstate.shop/cjcblend",
        image: "/cjc-ipa-product.png",
      },
      {
        name: "BPC-157 + TB-500",
        amount: "20mg Blend (2 vials)",
        url: "https://www.peakstate.shop/bpcblend",
  ...
  pricing: {
    ...
    tiers: [
      ...
      },
      {
        ...
        price: "$1,259",
        perStackPrice: "Only $419 per stack",
        installment: "$314.75",
        savings: "$150",
        ctaLabel: "Lock In My Stack",
